    ...
    >
      ...
      <div className="trace-line__track" aria-hidden="true">
        <motion.span
          ...
          initial={{ scaleY: 0 }}
          transition={{ duration: 0.72, ease: lineEase }}
        ...
        <motion.span
          ...
          transition={{ duration: 0.32, delay: 0.48, ease: lineEase }}
          viewport={{ once: true, amount: 0.6 }}
        ...
        <motion.span
          ...
          initial={{ scaleY: 0 }}
          transition={{ duration: 0.72, delay: 0.18, ease: lineEase }}
          viewport={{ once: true, amount: 0.6 }}
          whileInView={{ scaleY: 1 }}
        />
      </div>
      <motion.time
        ...
        initial={{ opacity: 0, y: direction === "back" ? -8 : 8 }}
        transition={{ duration: 0.5, delay: 0.72, ease: lineEase }}
        viewport={{ once: true, amount: 0.6 }}
